                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-sm-3 col-md-3 col-lg-6">
                                        ...
                                        <select data-column="1" class="form-control form-control-sm filter select2" id="customer_id" name="customer_id">
        ...
        $(document).ready(function(){
                    ...
                    <div class="col-md-${colmd}">
                        <div class="dataTables_filter" style="display: flex; align-items: center; justify-content: center;">
                            <label style="font-weight: normal; white-space: nowrap; display: flex; align-items: center;margin-bottom: .5rem;">
                                Status Filter:
                                <select data-column="1" class="form-control form-control-sm filter select2" id="status_filter" name="status_filter" style="margin-left: 10px;">
            ...
            ajax: {
                ...
                dataSrc: function(json){
                    // setTimeout(() => {
                    //     if (status_filter_type && status_filter_value) {
                    //         const combinedValue = `${status_filter_type}.${status_filter_value}`;
                    //         $('#status_filter').val(combinedValue).trigger('change');
                    //     }
                    // }, 0);

                    // $('#status_filter option:selected').val(status_filter_type+'.'+status_filter_value);
                    $('#status_filter option:selected').val(status_filter_type+'.'+status_filter_value);
                    return json.data;
                }
            },
