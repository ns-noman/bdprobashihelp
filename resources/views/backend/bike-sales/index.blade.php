        ...
        $(document).ready(function(){
            ...
            columns: [
                        ...
                        { 
                            ...
                            searchable: false, 
                            render: function(data, type, row, meta) {
                                let view = `{{ route('bike-service-records.invoice', ":id") }}`.replace(':id', row.id);
                                let print = `{{ route('bike-service-records.invoice.print', [":id","print"]) }}`.replace(':id', row.id);
            ...
            $(document).on('click', '.nametransfer', function(e) {
                ...
                // }).then((result) => {
                //     if (result.isConfirmed) {
                //         const url = `{ rte('bike-sales.name-transfers', ":id") }}`.replace(':id', transaction_id);
                //         $.ajax({
                //             url: url,
                //             method: 'GET',
                //             dataType: 'JSON',
