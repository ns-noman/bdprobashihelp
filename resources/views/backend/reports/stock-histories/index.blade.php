                ...
                dataSrc: function(json) {
                    ...
                    if (json.data.length) {
                        ...
                        for (let index = 0; index < json.data.length; index++) {
                            inQty += parseFloat(json.data[index].stock_in_qty || 0);
                            outQty += parseFloat(json.data[index].stock_out_qty || 0);
                        }
                        balance = (inQty - outQty);
                        document.getElementById('totalInQty').innerHTML = "+" + inQty + ' ' + json.data[0].unit_name;
                        document.getElementById('totalOutQty').innerHTML = "-" + outQty + ' ' + json.data[0].unit_name;
                        document.getElementById('balanceQty').innerHTML = balance + ' ' + json.data[0].unit_name;
                    }
                    return json.data;
                }
            },
