                ...
                dataSrc: function(json) {
                    ...
                    if (json.data.length) {
                        for (let index = 0; index < json.data.length; index++) {
                            let subtotal = json.data[index].current_stock * json.data[index].purchase_price;
                            totalStockValue += parseFloat(subtotal);
                        }
                    }
                    document.getElementById('totalStockValue').innerHTML = formatNumber(totalStockValue);
                    return json.data;
                }
            },
            columns: [
