                      ...
                      <div class="invoice p-3 mb-3" id="my-invoice">
                          ...
                          <div class="row invoice-info" style="margin-top: 100px;">
                              <div class="col-sm-4 invoice-col">
                                  <strong>Report Name: </strong>Account Ledger Report<br>
                                  <strong>Agent Info: </strong>{{ $data['customer_info']['name'] }}<br>
                                  ...
                                  <table class="table table-striped">
                                      <thead>
                                        ...
                                        <tbody>
                                            @php
                                                if (count($data['lists'])) {
                                                    $brought_forword = $data['lists'][0]['current_balance'] - $data['lists'][0]['credit_amount'] + $data['lists'][0]['debit_amount'];
                                                    $bfRow =
                                                    [ 
                                                        'date'=> '',
                                                        'particular'=> 'B/F',
                                            ...
                                            @foreach ($data['lists'] as $list)
                                                <tr style="text-align: center">
                                                    ...
                                                    <td>
                                                        {{ $list['particular'] }}
                                                        @if(!empty($list['invoice_no']))
                                                            <a href="{{ route('sales.invoice', $list['sale_id']) }}" target="_blank">
                                                                #{{ $list['invoice_no'] }}
                                                            </a>
                                                        @endif
                                                    </td>
