                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            ...
                            <form id="form-submit" action="{{ route('my-jobs.service-update',$data['jobServiceRecord']['id']) }}" method="POST" enctype="multipart/form-data">
                                @csrf()
                                @method('put')
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <div class="form-group col">
                                                    ...
                                                    <select name="status_id" id="status_id" class="form-control select2">
                                                        @foreach ($data['statusList'] as $statusList)
                                                            <option @selected($data['jobServiceRecord']['status_id'] == $statusList['id']) value="{{ $statusList['id'] }}">{{ $statusList['name_for_agent'] }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-12 col-md col-lg" id="medical_center_ids_div" hidden>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2" name="medical_center_ids[]" id="medical_center_ids" multiple="multiple" data-placeholder="Select Package Items" style="width: 100%;" required>
