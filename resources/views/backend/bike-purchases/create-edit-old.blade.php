                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                    ...
                                                    <input value="{{ isset($data['item']) ? $data['seller']->name : old('seller_name') }}" type="text" class="form-control" name="seller_name" id="seller_name" placeholder="Seller Name" required>
                                                </div>
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                    <label>Contact</label>
                                                    <input value="{{ isset($data['item']) ? $data['seller']->contact : old('contact') }}" type="text" class="form-control" name="contact" id="contact" placeholder="+8801XXXXXXXXX" required>
                                                </div>
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                    <label>Date Of Birth</label>
                                                    <input value="{{ isset($data['item']) ? $data['seller']->dob : old('dob') }}" type="date" class="form-control" name="dob" id="dob" required>
                                                </div>
                                                <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                                    <label>NID</label>
                                                    <input value="{{ isset($data['item']) ? $data['seller']->nid : old('nid') }}" type="text" class="form-control" name="nid" id="nid" placeholder="NID">
                                                </div>

                                                <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                                    <label>DL No</label>
                                                    <input value="{{ isset($data['item']) ? $data['seller']->dl_no : old('dl_no') }}" type="text" class="form-control" name="dl_no" id="dl_no" placeholder="DL No">
                                                </div>
                                                <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                                    <label>Passport No</label>
                                                    <input value="{{ isset($data['item']) ? $data['seller']->passport_no : old('passport_no') }}" type="text" class="form-control" name="passport_no" id="passport_no" placeholder="Passport No">
                                                </div>
                                                <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                                    <label>BCN No</label>
                                                    <input value="{{ isset($data['item']) ? $data['seller']->bcn_no : old('bcn_no') }}" type="text" class="form-control" name="bcn_no" id="bcn_no" placeholder="BCN No">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Broker Info -->
                                        ...
                                        <div class="col-12 mt-4">
                                            ...
                                            <input value="{{ isset($data['item']) ? $data['bike']->id : null }}" type="hidden" name="bike_id" id="bike_id">
                                            <div class="row">
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                    <label>Brands *</label>
                                                    <select class="form-control" name="brand_id" id="brand_id" required>
                                                        ...
                                                        @foreach ($data['brands'] as $brand)
                                                            <option @selected(isset($data['item']) && $data['bike']->brand_id == $brand['id']) value="{{ $brand['id'] }}">{{ $brand['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                ...
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                    ...
                                                    <select class="form-control" name="color_id" id="color_id" required>
                                                        ...
                                                        @foreach ($data['colors'] as $colors)
                                                            <option @selected(isset($data['item']) && $data['bike']->color_id == $colors['id']) value="{{ $colors['id'] }}">{{ $colors['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                    <label>Chassis No *</label>
                                                    <input value="{{ isset($data['item']) ? $data['bike']->chassis_no : old('chassis_no') }}" type="text" class="form-control" name="chassis_no" id="chassis_no" placeholder="Chassis No" required autocomplete="off">
                                                </div>
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                    <label>Engine No *</label>
                                                    <input value="{{ isset($data['item']) ? $data['bike']->engine_no : old('engine_no') }}" type="text" class="form-control" name="engine_no" id="engine_no" placeholder="Engine No" required autocomplete="off">
                                                </div>
                                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                                    <label>Registration No *</label>
                                                    <input value="{{ isset($data['item']) ? $data['bike']->registration_no : old('registration_no') }}" type="text" class="form-control" name="registration_no" id="registration_no" placeholder="Registration No" required autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Purchase Info -->
