        ...
        $(document).ready(function(){
            ...
            options.columns = 
                    [
                        ...
                        { data: 'contact', name: 'agents.contact'},
                        { data: 'address', name: 'agents.address'},
                        { data: 'dob', name: 'agents.dob'},
                        { data: 'nid', name: 'agents.nid'},
                        { data: 'balance', name: 'agents.balance'},
                        { 
                            data: null, 
                            name: 'agents.status', 
                            orderable: true, 
                        ...
                        { 
                            ...
                            searchable: false, 
                            render: function(data, type, row, meta) {
                                let edit = `{{ route('agents.edit', ":id") }}`.replace(':id', row.id);
                                let destroy = `{{ route('agents.destroy', ":id") }}`.replace(':id', row.id);
