                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            ...
                            <form id="form-submit" action="{{ route('sales.new-store',$data['item']->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf()
                                @if(isset($data['item']))
                                    @method('put')
                                @endif 
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-3 col-md-3 col-lg-2">
                                            ...
                                            <input name="passenger_name" id="passenger_name" type="text" value="{{ isset($data['item']) ? $data['item']->passenger_name : null }}" class="form-control" placeholder="Passenger Name" disabled>
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3 col-lg-2">
                                            <label>Passport No</label>
                                            <input name="passenger_passport_no" id="passenger_passport_no" type="text" value="{{ isset($data['item']) ? $data['item']->passenger_passport_no : null }}" class="form-control" placeholder="0123456789" disabled>
                                        </div>
                                        ...
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <input value="" step="0.01" type="number" class="form-control" name="discount_rate" id="discount_rate" placeholder="0.00">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            <label>Discount Amount</label>
                                            <input value="" readonly type="number" class="form-control" name="discount" id="discount" placeholder="0.00">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            <label>Total</label>
                                            <input value="" type="number" class="form-control" name="total_price" id="total_price" placeholder="0.00" readonly>
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            <label>Vat</label>
                                            <input value="" readonly value="0.00" type="number" class="form-control" name="vat_tax" id="vat_tax" placeholder="0.00">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            <label>Total Payable</label>
                                            <input value="" readonly type="number" class="form-control" name="total_payable" id="total_payable" placeholder="0.00">
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <select class="form-control" name="account_id" id="account_id">
                                                ...
                                                @foreach ($data['paymentMethods'] as $paymentMethod)
                                                    <option account-bal="{{ $paymentMethod['balance'] }}" value="{{ $paymentMethod['id'] }}">{{ $paymentMethod['name'] .' : '. $paymentMethod['account_no'] . ' (Bal: ' . $paymentMethod['balance'] }} &#2547;)</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            <label>Paid Amount</label>
                                            <input value="" value="0.00" step="0.01" type="number" 
